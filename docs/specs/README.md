...
| M3 | [Persistence](M3-persistence.md) | Save / resume runs, optional SysEx dump to Rytm | Shipped |
| M4 | [Better fitness & diversity](M4-fitness-and-diversity.md) | Mini-tournaments, adaptive mutation, niching | Next |

...
|---|-----------|------|--------|
| M0 | [Foundation cleanup](M0-foundation-cleanup.md) | Tidy module imports, drop legacy code, add `deap` | Not started |
| M1 | [End-to-end GA loop](M1-end-to-end-ga-loop.md) | Run one DEAP-driven run on one channel with LPD8 voting | Not started |
| M2 | [Quality of life](M2-quality-of-life.md) | Logging, replay-best, CLI config, elitism, clean shutdown | Not started |
| M3 | [Persistence](M3-persistence.md) | Save / resume runs, optional SysEx dump to Rytm | Not started |
